...
def run_predator_video_episode(
    model_path="model_Predators[0,1].zip",  # Predator 模型路径
    n_predators=5,
    n_preys=10,
...
def run_multiple_episodes(
    model_path="model_Predators[0,1].zip",
    n_predators=5,
    n_preys=10,
    n_episodes=3,
    output_dir="videos",
...
if __name__ == "__main__":
    ...
    run_predator_video_episode(
        model_path="model_Predators[0,1].zip",  # 你的 Predator 模型
        n_predators=5,                          # Predator 数量
        n_preys=10,                             # Prey 数量
        video_path="waterworld_predator_vs_random.mp4",
