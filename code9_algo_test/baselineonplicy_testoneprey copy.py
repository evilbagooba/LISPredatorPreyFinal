...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--lr", type=float, default=1e-4)  # PPO通常使用更高的学习率
    parser.add_argument(
    ...
    for agent_name in agents:
        ...
        if algo == "PPO":
            ...
            policy = PPOPolicy(
                ...
                max_grad_norm=0.5,  # 添加梯度裁剪     # 传入Box空间
...
def get_env(render_mode=None):
    ...
    agent_algos = ["PG", "PG", "PG", "PG"] * 50  # 给足够多的A2C算法
